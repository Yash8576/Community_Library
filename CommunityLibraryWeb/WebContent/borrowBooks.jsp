  ...
  <body>
    ...
    %>  
          <div class="alert alert-success alert-dismissible fade show">
            ...
            <strong>Success!</strong> The Owner has been notified, We'll get back to you soon!"
          </div>
    <%    
        }
        else
    ...
    %>
      <div align="right">
        <button type="button" class="btn btn-secondary" id="display-button">Display All Books</button>
        <button type="button" class="btn btn-secondary" id="register-button">Check Notifications</button>
      </div>
    </div>
    ...
    try
    {
      ...
      PreparedStatement statement = connection.prepareStatement("SELECT * FROM [dbo].[BOOK_MASTER]");
    ...
    %>   
          <div class="card" id="<%out.println(rset.getString(1));%>">
            ...
            <div class="card-footer" align="right">
              <form class="bookItemForm" action="bookSubscriptionProcess.jsp" method="post">
                <div class="form-group">Interested in this book ?</div>
                <div class="form-group">
                  <input class="form-control" name="bookId" id="bookId" type="hidden" value="<%out.println(rset.getString(1));%>">
                  <button class="btn btn-link" id="notifyButton" type="submit" data-toggle="popover" data-trigger="hover" data-content="The Owner of this book gets notified about your intrest in this book and will revert back on confirmation"
                   style="color: #76323F;">Notify the Owner ?</button>
                </div>
              </form>
            </div>
          </div>
    <%   
      ...
      {
    %>   
        <h2 align="center">Currently there are no books available, we will reach out to you soon!</h2>
    <%
      }
   }
   catch(Exception e) {
